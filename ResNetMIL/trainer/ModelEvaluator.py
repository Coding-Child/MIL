...
def test(model, test_loader, criterion_bag, criterion_instance, save_path):
    ...
    final_test_auc, final_test_f1, final_instance_loss, final_bag_loss, final_loss = evaluator(model,
                                                                                               test_loader,
                                                                                               criterion_bag,
                                                                                               criterion_instance)
    ...
    best_test_auc, best_test_f1, best_instance_loss, best_bag_loss, best_loss = evaluator(model,
                                                                                          test_loader,
                                                                                          criterion_bag,
                                                                                          criterion_instance)
    ...
    print(f'Best Model Total Loss: {best_loss:.4f} & Final Model Total Loss: {final_loss:.4f}')
